        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-10">
          ...
          >
            ...
            <div className="pr-10 mb-6">
              <div className="flex items-center gap-2 mb-1.5">
                ...
                <span className="text-xs font-mono text-emerald-500 font-medium">
                  Available for new opportunities & chats
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              ...
              {/* LinkedIn Direct Chat */}
              <div className="p-3.5 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border)] flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-mono uppercase tracking-wider text-[var(--fg-muted)] flex items-center gap-1">
                      <Linkedin className="w-3.5 h-3.5 text-[#0A66C2]" /> LinkedIn Message
                    </span>
                  </div>
                  <p className="text-xs text-[var(--fg-secondary)] leading-relaxed mb-2.5">
                    Connect directly or send a fast DM on LinkedIn.
                  </p>
                </div>
                <a
                  href={LINKEDIN}
            ...
            <form onSubmit={handleSendEmail} className="pt-4 border-t border-[var(--border)]/60">
              ...
              <div className="space-y-3 mb-4">
                ...
                <textarea
                  rows={3}
                  placeholder={`Hi Dipanshu, I'd like to talk about ${selectedTopic}...`}
                  value={senderMessage}
