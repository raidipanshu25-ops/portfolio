  ...
  return (
    <>
      ...
      <div className="hidden md:flex fixed bottom-0 left-10 flex-col items-center gap-6 z-50">
        <a
          href="https://github.com/raidipanshu25-ops"
          target="_blank"
          rel="noopener noreferrer"
          className="text-[var(--fg-secondary)] hover:text-[var(--accent)] hover:-translate-y-[3px] transition-all duration-300"
          aria-label="GitHub"
        >
          <GithubLogo className="w-[22px] h-[22px]" />
        </a>
        <a
          href="https://linkedin.com/in/dipanshu-kumar-6308a5335"
          target="_blank"
          rel="noopener noreferrer"
          className="text-[var(--fg-secondary)] hover:text-[var(--accent)] hover:-translate-y-[3px] transition-all duration-300"
          aria-label="LinkedIn"
        ...
        <div className="w-[1px] h-24 bg-[var(--fg-secondary)] opacity-40 mt-2"></div>
      </div>
